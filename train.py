...
def train(epoch):
    ...
    for batch in tqdm(training_data_loader):
        ...
        if iter == train_len:
            ...
            output_img.save(opt.val_folder+'training/test.jpg')
            gt_img.save(opt.val_folder+'training/gt.jpg')
...
def load_datasets():
    ...
    if opt.lol_v1 or opt.lol_blur or opt.lolv2_real or opt.lolv2_syn or opt.SID or opt.SICE_mix or opt.SICE_grad or opt.sid:
        if opt.sid:
